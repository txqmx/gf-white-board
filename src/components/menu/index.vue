<template>
  <div class="menu-container">
    <div :class="['menu-item', {'active-color':  drawType === 'move'}]" @click="selectType('move')">
...
<script>
import shapeRound from './img/shape-round.png'
import shapeSquare from './img/shape-square.png'
import shapeTriangle from './img/shape-triangle.png'
export default {
  name: 'index',
  data () {
    return {
      ...
      shapeType: 'arc', // 多边形类型
      shapes: [
        { type: 'arc', icon: shapeRound },
        { type: 'rect', icon: shapeSquare },
        { type: 'polygon', icon: shapeTriangle }
      ]// 圆、四边形、三角形
    }
  },
  methods: {
